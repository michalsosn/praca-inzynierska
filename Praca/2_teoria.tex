...
\todo[inline]{
Treść zaczerpnięta z UsersGuide\cite{GuideTypeFamilies}. Pamiętać o \code{data family}

Rodzina typów, otwarta i zamknięta, związana z klasą, rodzina typów danych, deklaracja i równanie, prawa i lewa strona równania, zmienna, \cite{LearnYouAHaskell}.
}

\subsectionex{Częściowe sygnatury typów}{Rozszerzenie \code{PartialTypeSignatures}}\label{sec:partial_sigs}
\todo[inline]{
Treść zaczerpnięta z UsersGuide\cite{GuidePartialTypeSignatures}. Pamiętać o \code{NamedWildCards}.

Symbol wieloznaczny/wieloznacznik, podkreślnik, nazwany i anonimowy, zmienna i wieloznacznik.
}
