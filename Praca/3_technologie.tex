...
\js{Nieco mylące stwierdzenie.  To że testy są uruchamiane przy użyciu skryptów
 Pythona nie oznacza, że w pisaniu GHC wykorzystano Pythona.  Co więcej, mimo
 pracy nad GHC od kilku lat moja znajomość Pythina jest zerowa, co pokazuje że
 dodawanie testów wcale nie wymaga znajomości tego języka.}
