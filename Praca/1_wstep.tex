...
Niektóre języki \js{w tym Haskell} zawierają jeszcze rodzaje (\foreign{kinds}), które pełnią wobec
...
\js{Naprawdę tym został podyktowany?  A może napisać o chęci zapoznania się z
  budową kompilatora, uczestnictwa w projekcie open source itd?  To znaczy tak
  podejrzewam że to mogło Pana zachęcić do tego tematu.  Po prostu zmierzam do
  tego żeby napisać prawdę :-)  Oczywiście jeśli ten zapis zostanie zmieniony
  to trzeba zmodyfikować tekst tak, żeby przejście do dalszej części dyskusji
  było płynne.}
...
\js{Może w tym kontekście warto gdzieśtam potem w pracy wspomnieć o \#11451 ?}
