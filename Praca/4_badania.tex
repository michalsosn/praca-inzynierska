...
Po zapoznaniu się z kod GHC, udało się odnaleźć miejsca odpowiadające za każdy z
...
dwa razy po lewej stronie równania. Obie sytuacje są pokazane we fragmencie
...
\code{warnUnusedMatches} przez zwyczajne sprawdzenie pierwszego znaku nazwy. Z
kolei anonimowe i nazwane symbole wieloznaczne nie wywołują ostrzeżeń, gdyż nie
