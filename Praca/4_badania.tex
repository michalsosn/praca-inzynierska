...
tych komunikatów. Była to funkcja \code{inaccessibleCoAxBranch} z modułu \code{TcValidity}
...
równe wartości, lecz równanie rodziny typów \code{Equal a a = ()} jest poprawne
i użyte przy aplikacji \code{Equal} do dwóch równych typów. Ze względu na to
...
funkcji \code{warnUnusedMatches} z \code{RnEnv} przez zwyczajne sprawdzenie jaki
